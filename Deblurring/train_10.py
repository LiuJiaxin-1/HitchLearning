...
def deblur_train(test_dir, save_root, option_path, dataname, img_name, nums=0):
    ...
    # opt.TRAINING.SAVE_DIR = save_root
    result_dir = os.path.join(save_root, mode, 'results')
    model_dir  = os.path.join(save_root, mode, 'models')
