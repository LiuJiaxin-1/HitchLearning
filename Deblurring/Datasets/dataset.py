...
class DataLoaderTrain(Dataset):
    def __init__(self, data_dir, raw, gt, raw_eliback=True, img_options=None, nums=0):
    ...
    def __getitem__(self, index):
        ...
        inp_img = utils.preprocess(inp_img, self.raw_eliback, True)
...
class DataLoaderSrcTrg(Dataset):
    ...
    def __getitem__(self, index):
        ...
        inp_src_img = utils.preprocess(inp_src_img, False, True)
