...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.MODEL.IN_CHAN = 1
        self._C.MODEL.N_FEAT = 96
        self._C.MODEL.BLINDSPOT = False
        self._C.MODEL.ZERO_LAST = False


        self._C.OPTIM = CN()
        self._C.OPTIM.BATCH_SIZE = 1
        self._C.OPTIM.NUM_WORKERS = 1
        self._C.OPTIM.NUM_EPOCHS = 100
        self._C.OPTIM.LR = 0.0002
        self._C.OPTIM.GAMMA = 0.5
        self._C.OPTIM.LAMBDA1 = 1.0
        self._C.OPTIM.LAMBDA2 = 1.0
        self._C.OPTIM.INCREASE_RATIO = 2.0
    

        self._C.TRAINING = CN()
        self._C.TRAINING.VAL_AFTER_EVERY = 3
        self._C.TRAINING.RESUME = False
        self._C.TRAINING.TRAIN_RAW_NAME = 'MBD5A90'
        self._C.TRAINING.TRAIN_GT_NAME  = 'GT'
        self._C.TRAINING.VAL_RAW_NAME = 'MBD5A90'
        self._C.TRAINING.VAL_GT_NAME  = 'GT'
        self._C.TRAINING.VAL_SUDOGT_NAME = 'SudoMDB'
        self._C.TRAINING.SRC_DIR = 'images_dir/train'
        self._C.TRAINING.TRG_DIR = 'images_dir/trg'
