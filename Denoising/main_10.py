...
def dn_main(dataname, image_name, test_dir, option_path, root, nums=0):
    ...
    save_logs_dir = os.path.join(root, mode, 'logs')
    save_models_dir = os.path.join(root, mode, 'models')
    save_metrics_dir = os.path.join(root, mode, 'metrics')
    save_images_dir = os.path.join(root, mode, 'images')
