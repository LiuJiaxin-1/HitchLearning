...
json_root = './options/ER/run-d4/train_F-actin_x2_'
image_type = 'ER'
...
roots = ['07', '08', '09']
dir = "/data/liujiaxin/Results/SR/F-actin/"
for root in roots:
    root = os.path.join(dir, root, 'Src')
    for i in range(len(test_paths_L)):
        ...
        for mode in modes:
            ...
            json_path = json_root + mode + 'b4.json'
            main(mode=mode, image_name=image_name, srcname='', finetune=False, root=root, image_type=image_type, 
