            ...
            for test_data in test_loader:
                ...
                if len(E_imgs.shape) == 3:
                    for image_path, L_img, E_img, H_img in zip(test_data['H_path'], L_imgs, E_imgs, H_imgs):
                        ...
                        current_psnr = calculate_psnr(H_img, E_img_norm, data_range=1)
                        current_ssim = calculate_ssim(H_img, E_img_norm, data_range=1)
                        current_mse = calculate_mse(H_img, E_img_norm)
