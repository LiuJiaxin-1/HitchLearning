...
基于Src模型进行finetune,每个10个step测试一次
json文件在run-d4-f中
'''
import os
import utils.utils_image as util
from main_train_SR import main
json_root = './options/F_actin/run-d4-f/train_F-actin_x2_'
image_type = 'F_actin'
...
for i in range(len(test_paths_L)):
    ...
    for mode in modes:
        ...
        main(mode=mode, image_name=image_name, srcname='ER-D4', finetune=True, image_type=image_type, test_dataroot=test_data, test_img_nums=0, train_img_nums=10, dataseed=1, json_path=json_path)