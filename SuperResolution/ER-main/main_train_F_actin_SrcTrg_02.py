...
for i in range(49, len(test_paths_L)):
    ...
    for mode in modes:
        ...
        json_path = json_root + mode + '02.json'
        main(mode=mode, image_name=image_name, srcname='ER-D4', finetune=False, image_type=image_type, test_dataroot=test_data, test_img_nums=0, train_img_nums=10, dataseed=1, json_path=json_path)