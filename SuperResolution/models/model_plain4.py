...
class ModelPlain4(ModelBase):
    ...
    # initialize training
    # ----------------------------------------
    def init_train(self, init_optimizer=True):
    ...
    # feed L/H data
    # ----------------------------------------
    def feed_data(self, data, train_flag=True, need_H=True):
    ...
    def netG_forward(self):
        ...
        #     # x_min = torch.min(x[i,...])
        #     # x_max = torch.max(x[i,...])
        #     self.E[i,...] = (self.E[i,...] - torch.min(self.E[i,...])) / (torch.max(self.E[i,...]) - torch.min(self.E[i,...]) + 1e-7)


    # ----------------------------------------
    # update parameters and get loss
    # ----------------------------------------
    def optimize_parameters(self, current_step, Lambda=1):
