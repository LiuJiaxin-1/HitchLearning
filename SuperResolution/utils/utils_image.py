...
# --------------------------------------------
# process images
# delet background, norm and get patches
# --------------------------------------------
'''
...
def generate_subimages(img, mask):
    # using mask1 and mask2 to generate subimages
    n, c, h, w = img.shape
...
# # --------------------------------------------
# # calculate MAE of HR and output 
# # --------------------------------------------
