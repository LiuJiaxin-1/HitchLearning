...
def main(mode, image_name, srcname, image_type, dataseed=0, test_dataroot=None, train_img_nums=0, test_img_nums=0,json_path='./options/train_F-actin_x2_psnr.json'):
    ...
    if not mode == 'Src':
        ...
        opt['datasets']['update']['dataroot_H'] = opt['datasets']['train']['dataroot_H']
    ...
    # for epoch in range(100000):
        ...
        if epoch % opt['train']['checkpoint_test'] == 0 or epoch == 1:
            ...
            for test_data in test_loader:
                ...
                logger.info('{:->4d}--> {:>10s} | PSNR:{:<4.2f}dB | SSIM:{:<4.4f} | MSE:{:<4.5f}dB'
            ...
            # testing log
            logger.info('<epoch:{:3d}, iter:{:8,d}, Average PSNR : {:<.2f}dB,  Average SSIM : {:<.4f}, Average MSE : {:<.4f}\n'
            .format(epoch, current_step, avg_psnr, avg_ssim, avg_mse))
