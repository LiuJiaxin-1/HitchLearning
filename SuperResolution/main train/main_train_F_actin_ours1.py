...
for i in range(len(test_paths_L)):
    ...
    for mode in modes:
        ...
        main(mode=mode, image_name=image_name, srcname='SR', finetune=True, image_type=image_type, test_dataroot=test_data, test_img_nums=0, train_img_nums=10, dataseed=1, json_path=json_path)