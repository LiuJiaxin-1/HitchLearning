...
from main_train_H import main
json_root = './options/F_actin/run-d5/train_F-actin_x2_'
image_type = 'F_actin'
...
for i in range(len(test_paths_L)):
    ...
    for mode in modes:
        ...
        json_path = json_root + mode + 'F_H.json'
        main(mode=mode, image_name=image_name, srcname='ER', image_type=image_type, test_dataroot=test_data, test_img_nums=0, train_img_nums=10, dataseed=1, json_path=json_path)